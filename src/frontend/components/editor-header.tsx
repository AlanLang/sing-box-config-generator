          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              <Input
                ...
                className="flex-1 max-w-md text-lg font-semibold border-0 border-b-2 border-transparent bg-transparent focus-visible:border-b-primary focus-visible:ring-0 rounded-none px-2 transition-colors"
        ...
        <div className="flex sm:hidden items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <Input
              value={name}
              onChange={(e) => onNameChange(e.target.value)}
              className="flex-1 text-base font-semibold border-0 border-b-2 border-transparent bg-transparent focus-visible:border-b-primary focus-visible:ring-0 rounded-none px-2 transition-colors"
              placeholder={`${entityType} name...`}
            />
          </div>
        </div>
