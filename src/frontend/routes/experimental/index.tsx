...
function RouteComponent() {
  ...
  const handleCopy = (experimental: {
    ...
    setIsCreating(true);
    setSelectedUuid(null);
    setEditName(`${experimental.name}-复制`);
    setEditJson(experimental.json);
    setEditUuid(uuidv4());
    setFocusMode(true);
  };
  ...
  return (
    ...
    >
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>删除 Experimental</AlertDialogTitle>
            <AlertDialogDescription>
              确定要删除 "{selectedExperimental?.name}" 吗？此操作无法撤销。
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={deleteExperimentalMutation.isPending}
            >
              {deleteExperimentalMutation.isPending ? "删除中..." : "确认删除"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
      ...
      <UsageWarningDialog
        ...
        itemName={selectedExperimental?.name || ""}
